...
import Smoketwo from "../components/Smoketwo";
    ...
    return (
        <div className="overflow-hidden relative">
            ...
            <div className="w-screen">
                ...
                <div className="fixed left-0 top-[90vh] transform -translate-y-1/2 z-40 hidden lg:block">
                    <div className="flex items-end mb-10 relative">
                        <div className="absolute inset-0 flex items-end justify-center z-0">
                            {/* <Smoketwo /> */}
                        </div>
                        <img src={product} alt="Fixed Right Image" className="w-[20rem] relative z-10" />
                    </div>
                </div>
                <div className="w-full">
                    <div className="h-full w-full relative px-4 md:px-0 mt-24 lg:mt-48">
                            ...
                            <div className="relative should overflow-hidden touch-pan-y">
                                ...
                                >
                                    {t.home.reviews.map((review) => (
                                        ...
                                        >
                                            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 w-full max-w-lg h-64 overflow-hidden">
                                                <h3 className="text-lg font-bold mb-2">{review.name}</h3>
                                                <p className="text-gray-600 mb-3 overflow-ellipsis overflow-hidden">{review.review}</p>
