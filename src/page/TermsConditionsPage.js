...
const TermsConditionsPage = ({ currentLang }) => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-lg p-10">
                <h1 className="text-4xl font-extrabold text-center mb-4">{t.termsConditions.title}</h1>
                <p className="text-center text-gray-600 mb-10">
                    {t.termsConditions.lastUpdated}
                </p>

                <div className="space-y-8">
                    {t.termsConditions.sections.map((section, index) => (
                ...
                <div className="mt-10 bg-blue-50 p-6 rounded-lg">
                    <p className="text-blue-800 font-medium mb-4">
                        {t.termsConditions.disclaimer}
                    </p>
                    <p className="text-blue-800 font-medium">
                        {t.termsConditions.contactTerms}
                    </p>
                </div>
            </div>
            <div className="">
